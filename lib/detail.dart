...
class _DetailState extends State<Detail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: !cc & !ch?Text("----"):Text(vid["title"]),
          ),
      body: Container(
        child: !cc && !ch
            ? Center(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () =>
                              play(vid["videos"]["results"][index]["key"]),
                          child: new Card(
                            child: Column(
                              children: <Widget>[
                                Container(
